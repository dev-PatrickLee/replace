...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/static/css/mypage/invited-seat.css">
			...
			<nav role="presentation" class="Nav_Nav">
				<h2 class="Nav_Nav_title">
					...
					<button type="button" class="Nav_Nav_button">
						제안받기 현황 <span class="Nav_Nav_subTitle">받은 제안</span> <span
							class="Nav_Nav_open_icon"></span>
					</button>
				</h2>
				<ul class="Nav_Nav_list">
					<li><a
						href="https://www.wanted.co.kr/profile/status?type=matchup-all"
						class>열람한 자리</a></li>
					<li><a
						href="https://www.wanted.co.kr/profile/status?type=matchup-likes">관심
							있음</a></li>
					<li><a
						href="https://www.wanted.co.kr/profile/status?type=matchup-opens">지원한
							자리</a></li>
					<li><a
						href="https://www.wanted.co.kr/profile/status?type=matchup-offers"
						class="Nav_Nav_list_active">초대받은 자리</a></li>
				</ul>
			</nav>
		</div>
					...
					<dd>
						<ul>
							...
							<li class="active"><a
								href="https://www.wanted.co.kr/profile/status?type=matchup-offers"
								class> 초대받은 자리
									<div class="label_"><%=request.getAttribute("invitationCount") %></div>
							</a></li>
						</ul>
					</dd>
				</dl>
								...
								<a href="">
									<div class="invitation_card">
										<div class="company_wrapper">
											<img
												src="${pageContext.request.contextPath}/static/images/invitation-card.png"
												alt="invitation-card">
											<div class="company_position">${vo.positionName }
												<br> ${vo.positionDetail }
											</div>
											<div class="company_name">${vo.companyName }</div>
										</div>
									</div>
								</a>
							</c:forEach>
	...
	<div class="toastMessage Notice_Notice">
		<span class="Notice_Notice_icon Notice_green__xs Notice_noIcon">
			<svg width="24" height="25" viewBox="0 0 24 25" fill="none"
				xmlns="https://www.w3.org/2000/svg" class="Notice_LargeCheckIcon">
                <path
					d="M5.53033 10.9697C5.23744 10.6768 4.76256 10.6768 4.46967 10.9697C4.17678 11.2626 4.17678 11.7374 4.46967 12.0303L9.46967 17.0303C9.76256 17.3232 10.2374 17.3232 10.5303 17.0303L19.5303 8.03033C19.8232 7.73744 19.8232 7.26256 19.5303 6.96967C19.2374 6.67678 18.7626 6.67678 18.4697 6.96967L10 15.4393L5.53033 10.9697Z"
					fill="black"></path>
            </svg>
		</span> <span></span>
	</div>
